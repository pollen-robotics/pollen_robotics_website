...
export default function CookieConsent() {
  ...
  const [selection, setSelection] = useState<ConsentMap>(() => getConsent());
  ...
  return (
    <>
          ...
          <Stack spacing={1.5}>
            <Stack direction="row" spacing={1.5} sx={{ alignItems: "flex-start" }}>
              <Box
                ...
                alt=""
                sx={{ width: 56, height: 56, flexShrink: 0, mt: 0.25 }}
              />
              <Box>
            ...
            <Stack direction="row" spacing={1} sx={{ width: "100%" }}>
              <Button variant="contained" size="small" onClick={handleAcceptAll} sx={{ flex: 1 }}>
                Accept
              </Button>
              <Button variant="outlined" size="small" onClick={handleRejectAll} sx={{ flex: 1 }}>
                Reject
              </Button>
              <Button
                variant="text"
      ...
      >
        ...
        >
          Cookie preferences
          <IconButton aria-label="Close" onClick={() => setPrefsOpen(false)} size="small">
