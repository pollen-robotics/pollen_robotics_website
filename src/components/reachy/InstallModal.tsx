...
export default function InstallModal({
  ...
  const isLinux = useMemo(() => {
    ...
    const platform = (navigator as Navigator).platform?.toLowerCase() || "";
      ...
      <DialogContent sx={{ p: 0, overflow: "hidden", borderRadius: "20px" }}>
        <Box sx={{ p: 3 }}>
          <Box sx={{ display: "flex", gap: 2.5 }}>
            ...
            <Box sx={{ flex: 1, minWidth: 0, pr: 4 }}>
              ...
              <Typography
                sx={{ fontSize: 13.5, color: "#666", lineHeight: 1.6, mt: 1.5 }}
              >
                {description}
              </Typography>
            </Box>
        ...
        <Box sx={{ p: 3 }}>
          ...
          >
            ...
            <Box sx={{ flex: 1 }}>
              <Typography
                sx={{ fontSize: 14, fontWeight: 700, color: "#1a1a1a", mb: 0.75 }}
              >
                Reachy Mini Desktop App required
              </Typography>
              <Typography sx={{ fontSize: 13, color: "#666", lineHeight: 1.6, mb: 1.5 }}>
                No robot?{" "}
                <Link
                  href="#"
                  sx={{
